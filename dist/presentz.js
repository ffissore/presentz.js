...
(function() {
  var BlipTv, Html5Video, IFrameSlide, ImgSlide, NoSlide, Presentz, RvlIO, SlideShare, SlideShareOEmbed, SpeakerDeck, SwfSlide, Video, Vimeo, WistiaPlugin, Youtube, root,
  ...
  Presentz = (function() {
    ...
    function Presentz(videoContainer, videoWxH, slideContainer, slideWxH) {
      ...
      this.videoPlugins = [this.availableVideoPlugins.vimeo, this.availableVideoPlugins.youtube, this.availableVideoPlugins.wistia_plugin];
  ...
  WistiaPlugin = (function() {
    ...
    WistiaPlugin.prototype.changeVideo = function(videoData, wouldPlay) {
      ...
      return this.ensureWistiaIframeAPILoaded(function() {
        var video;
