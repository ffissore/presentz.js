...
(function() {
  var BlipTv, Html5Video, ImgSlide, Presentz, SlideShare, SpeakerDeck, SwfSlide, Video, Vimeo, YoutubeIFrame,
  ...
  YoutubeIFrame = (function() {
    ...
    function YoutubeIFrame(presentz, videoContainer, width, height) {
      this.presentz = presentz;
      this.videoContainer = videoContainer;
      this.width = width;
      this.height = height;
    ...
    YoutubeIFrame.prototype.changeVideo = function(videoData, wouldPlay) {
      ...
      if (jQuery(this.videoContainer).children().length === 0) {
        ...
        this.player.cueVideoById(videoId(videoData));
      }
    };
    ...
    YoutubeIFrame.prototype.onReady = function() {
      if (!this.presentz.intervalSet) {
        this.presentz.startTimeChecker();
      }
      if (this.wouldPlay) {
    ...
    YoutubeIFrame.prototype.handleEvent = function(event) {
    ...
    YoutubeIFrame.prototype.play = function() {
      return this.player.playVideo();
    };
  ...
  Presentz = (function() {
    ...
    function Presentz(videoContainer, videoWxH, slideContainer, slideWxH) {
      ...
      this.videoPlugins = [new Vimeo(this, videoContainer, videoWxHParts[0], videoWxHParts[1]), new YoutubeIFrame(this, videoContainer, videoWxHParts[0], videoWxHParts[1]), new BlipTv(this, videoContainer, videoWxHParts[0], videoWxHParts[1])];
