...
(function() {
  ...
  SambatechPlugin = (function() {
    ...
    function SambatechPlugin(presentz1, videoContainer1, width1, height1) {
      this.presentz = presentz1;
      this.videoContainer = videoContainer1;
      this.width = width1;
      this.height = height1;
    ...
    SambatechPlugin.prototype.changeVideo = function(videoData, wouldPlay1) {
    ...
    SambatechPlugin.prototype.skipTo = function(time, wouldPlay) {
      ...
      if (((ref = this.player) != null ? ref.seek : void 0) != null) {
  ...
  WistiaPlugin = (function() {
    ...
    function WistiaPlugin(presentz1, videoContainer1, width1, height1) {
      this.presentz = presentz1;
      this.videoContainer = videoContainer1;
      this.width = width1;
      this.height = height1;
    ...
    WistiaPlugin.prototype.changeVideo = function(videoData, wouldPlay1) {
      this.wouldPlay = wouldPlay1;
    ...
    WistiaPlugin.prototype.currentTime = function() {
      var ref;
      if (((ref = this.player) != null ? ref.time : void 0) != null) {
    ...
    WistiaPlugin.prototype.skipTo = function(time, wouldPlay) {
      ...
      if (((ref = this.player) != null ? ref.seekTo : void 0) != null) {
        if (wouldPlay || this.isPaused()) {
  ...
  Video = (function() {
    function Video(playStates, pauseStates, finishStates, presentz1) {
    ...
    Video.prototype.handleEvent = function(event) {
      ...
      this.isInPlayState = indexOf.call(this.playStates, event) >= 0;
      this.isInPauseState = indexOf.call(this.pauseStates, event) >= 0 || !this.isInPlayState;
      this.isInFinishState = indexOf.call(this.finishStates, event) >= 0;
  ...
  Html5Video = (function() {
    function Html5Video(presentz1, videoContainer1, width1, height1) {
      this.presentz = presentz1;
      this.videoContainer = videoContainer1;
      this.width = width1;
      this.height = height1;
    ...
    Html5Video.prototype.changeVideo = function(videoData, wouldPlay1) {
  ...
  Vimeo = (function() {
    function Vimeo(presentz1, videoContainer1, width1, height1) {
      this.presentz = presentz1;
      this.videoContainer = videoContainer1;
      this.width = width1;
      this.height = height1;
      this.receiveVideoInfo = bind(this.receiveVideoInfo, this);
    ...
    Vimeo.prototype.changeVideo = function(videoData1, wouldPlay1) {
      var ajaxCall;
  ...
  Youtube = (function() {
    ...
    function Youtube(presentz1, videoContainer1, width1, height1) {
      this.presentz = presentz1;
      this.videoContainer = videoContainer1;
      this.width = width1;
      this.height = height1;
    ...
    Youtube.prototype.changeVideo = function(videoData, wouldPlay1) {
      this.wouldPlay = wouldPlay1;
    ...
    Youtube.prototype.currentTime = function() {
      var ref;
      if (((ref = this.player) != null ? ref.getCurrentTime : void 0) != null) {
  ...
  BlipTv = (function() {
    function BlipTv(presentz1, videoContainer, width, height) {
      this.presentz = presentz1;
      this.video = new Html5Video(this.presentz, videoContainer, width, height);
    }

    BlipTv.prototype.changeVideo = function(videoData, wouldPlay1) {
      var ajaxCall;
      this.wouldPlay = wouldPlay1;
      ajaxCall = {
        url: videoData.url,
  ...
  ImgSlide = (function() {
    function ImgSlide(presentz1, slideContainer1) {
      this.presentz = presentz1;
      this.slideContainer = slideContainer1;
    ...
    ImgSlide.prototype.preload = function(slide) {
      var image, ref;
      if ((ref = slide.url, indexOf.call(this.preloadedSlides, ref) >= 0)) {
        return;
      }
      image = new Image();
      image.src = slide.url;
  ...
  SlideShare = (function() {
    function SlideShare(presentz1, slideContainer1, width1, height1) {
      this.presentz = presentz1;
      this.slideContainer = slideContainer1;
      this.width = width1;
      this.height = height1;
  ...
  SlideShareOEmbed = (function() {
    function SlideShareOEmbed(presentz1, slideContainer1) {
      this.presentz = presentz1;
      this.slideContainer = slideContainer1;
      this.elementId = this.presentz.newElementName();
      this.preloadedSlides = [];
    ...
    SlideShareOEmbed.prototype.preload = function(slide) {
      ...
      this.ensureSlideInfoFetched(slide.public_url, (function(_this) {
        return function() {
          ...
          if ((indexOf.call(_this.preloadedSlides, url) >= 0)) {
            return;
          }
          image = new Image();
          image.src = url;
  ...
  SwfSlide = (function() {
    function SwfSlide(presentz1, slideContainer1, width1, height1) {
      this.presentz = presentz1;
      this.slideContainer = slideContainer1;
      this.width = width1;
      this.height = height1;
  ...
  SpeakerDeck = (function() {
    function SpeakerDeck(presentz1, slideContainer1, width1, height1) {
      this.presentz = presentz1;
      this.slideContainer = slideContainer1;
      this.width = width1;
      this.height = height1;
        ...
        this.pingInterval = setInterval((function(_this) {
          return function() {
            ...
            if ($speakerDeckIframe.length > 0 && $speakerDeckIframe[0].contentWindow) {
              return _this.speakerdeck = $speakerDeckIframe[0].contentWindow;
            }
          };
        })(this), 500);
      } else {
  ...
  IFrameSlide = (function() {
    function IFrameSlide(presentz1, slideContainer1) {
      this.presentz = presentz1;
      this.slideContainer = slideContainer1;
  ...
  RvlIO = (function(superClass) {
    extend(RvlIO, superClass);
  ...
  Presentz = (function() {
    ...
    Presentz.prototype.init = function(presentation) {
      var chapter, i, j, len, len1, ref, ref1, slide;
      ...
      this.currentChapterIndex = -1;
      this.currentSlideIndex = -1;
      ref = this.presentation.chapters;
    ...
    Presentz.prototype.changeChapter = function(chapterIndex, slideIndex, play, callback) {
      var i, len, listener, ref, targetChapter, targetSlide;
      if (callback == null) {
      ...
      if (chapterIndex !== this.currentChapterIndex || (this.currentChapterIndex !== -1 && this.presentation.chapters[this.currentChapterIndex].video._plugin.skipTo(targetSlide.time, play))) {
        ...
        if (chapterIndex !== this.currentChapterIndex) {
          ...
          ref = this.listeners.videochange;
          for (i = 0, len = ref.length; i < len; i++) {
            listener = ref[i];
    ...
    Presentz.prototype.changeSlide = function(chapterIndex, slideIndex) {
      var i, j, len, len1, listener, next4Slides, nextSlide, previousSlideIndex, ref, slide;
      ...
      for (i = 0, len = next4Slides.length; i < len; i++) {
        nextSlide = next4Slides[i];
        if (nextSlide._plugin.preload != null) {
          nextSlide._plugin.preload(nextSlide);
        }
      }
      ref = this.listeners.slidechange;
    ...
    Presentz.prototype.checkSlideChange = function(currentTime) {
      var candidateSlide, i, j, len, len1, listener, ref, slide, slides;
