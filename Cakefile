...
task "build", ->
  command = [
    "mkdir -p build"
    "rm -rf build/*"
    "coffee -o build -j PresentzTmp -c src/Video.coffee src/Html5.coffee src/Vimeo.coffee src/Youtube.coffee src/BlipTv.coffee src/ImgSlide.coffee src/SlideShare.coffee src/Presentz.coffee"
