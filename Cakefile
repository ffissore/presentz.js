...
task "build", ->
  exec [
    "mkdir -p dist"
    "rm -rf dist/*"
    "coffee -o dist -j presentz_tmp -c src/strict.coffee src/Video.coffee src/Html5Video.coffee src/Vimeo.coffee src/Youtube.coffee src/BlipTv.coffee src/ImgSlide.coffee src/SlideShare.coffee src/SlideShareOEmbed.coffee src/SwfSlide.coffee src/SpeakerDeck.coffee src/IFrameSlide.coffee src/RvlIO.coffee src/Presentz.coffee"
